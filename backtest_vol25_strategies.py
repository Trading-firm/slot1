...
# Vol 25 Specific Risk Settings (from settings.py or defaults)
SL_ATR_MULT = 1.2 # As per settings.py VOL25_SL_ATR_MULT
TP_ATR_MULT = 1.5 # As per settings.py VOL25_TP_ATR_MULT
...
def get_data(symbol, timeframe, n=1000): # Load less data for faster testing
    ...
    symbols_to_try = [symbol, "Volatility 25 Index", "R_25", "Vol 25 Index"]
